...
<meta name="description" content="O melhor e mais completo servi?s laboratoriais de Manaus.">
...
<title>Blog « Contato « CDL Laboratóios Santos e Vidal - Manaus / Amazonas</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
                ...
                <section class="slice sct-color-1">
                        <div class="container">
                            <div class="row cols-md-space cols-sm-space cols-xs-space">
                                ...
                                <?php do { ?>
                                <!-- item -->
                                <div class="col-lg-6 b-xs-bottom">
                                  <span class="space-xs-xl"></span>
                                    <div class="px-4">
                                        <div class="block block-image-holder">
                                            <div class="block-image has-solid-shadow-right">
                                                <a href="d.php?id=<?php echo $row_rsBlog['DIC_COD']; ?>">
                                                  
                                                    <img src="../images/content/dicas/<?php echo $row_rsBlog['DIC_COD']; ?>.jpg" class="img-fluid img-center">
                                                </a>
                                            </div>

                                            <div class="pt-5">
                                                <h3 class="heading heading-4 strong-600">
                                                    <a href="d.php?id=<?php echo $row_rsBlog['DIC_COD']; ?>"><?php echo $row_rsBlog['DIC_TITULO']; ?></a>
                                                </h3>
                                            </div>
                                            ...
                                            <div class="block-author">
                                                <div class="author-info">
                                                    <div class="author-name">
                                                        <span>
                                                          <?php echo $row_rsBlog['DIC_CORPO_HOME']; ?>
                                                            
                                                          </span>
                                                        <a href="d.php?id=<?php echo $row_rsBlog['DIC_COD']; ?>" class="link c-base-1 strong-600">[ Leia Mais ]</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
