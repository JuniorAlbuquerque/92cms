                                        ...
                                        <div class="tabs tabs--style-2" role="tabpanel">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#tabTwo-<?php echo $row_rsCheckups['PRD_COD']; ?>-1" aria-controls="home" role="tab" data-toggle="tab" class="nav-link active text-center text-normal strong-600">Sobre este Check-Up</a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#tabTwo-<?php echo $row_rsCheckups['PRD_COD']; ?>-2" aria-controls="profile" role="tab" data-toggle="tab" class="nav-link text-center text-normal strong-600">Lista de Exames</a>
                                                    </li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane" id="tabTwo-<?php echo $row_rsCheckups['PRD_COD']; ?>-2">
                                                        <div class="tab-body">
                                                            <p>
