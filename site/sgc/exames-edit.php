...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_exames SET EXA_NOME=%s, EXA_SIGLA=%s, EXA_TAGS=%s, EXA_ORIENTACOES=%s, EXA_AGENDAMENTO=%s, EXA_STATUS=%s WHERE EXA_COD=%s",
                       GetSQLValueString($_POST['EXA_NOME'], "text"),
                       GetSQLValueString($_POST['EXA_SIGLA'], "text"),
                       GetSQLValueString($_POST['EXA_TAGS'], "text"),
                       GetSQLValueString($_POST['EXA_ORIENTACOES'], "text"),
                       GetSQLValueString($_POST['EXA_AGENDAMENTO'], "int"),
                       GetSQLValueString($_POST['EXA_STATUS'], "int"),
                       GetSQLValueString($_POST['EXA_COD'], "int"));
...
$colname_rsExames = "-1";
if (isset($_GET['URL_EXA_COD'])) {
  $colname_rsExames = $_GET['URL_EXA_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsExames = sprintf("SELECT * FROM tb_exames WHERE EXA_COD = %s", GetSQLValueString($colname_rsExames, "int"));
...
<title>Editar &laquo; Exames &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="EXA_COD" type="hidden" id="EXA_COD" value="<?php echo $row_rsExames['EXA_COD']; ?>" />
                  <div class="formRight"><input name="EXA_NOME" type="text" id="EXA_NOME" value="<?php echo $row_rsExames['EXA_NOME']; ?>"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                      <label>Status</label>
                        <div class="formRight">
                        <select name="EXA_STATUS" id="EXA_STATUS" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsExames['EXA_STATUS']))) {echo "selected=\"selected\"";} ?>>0 - Inativa</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsExames['EXA_STATUS']))) {echo "selected=\"selected\"";} ?>>1 - Ativa</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                  </div>
                  ...
                  <div class="rowElem">
                      <label>Agendamento?</label>
                        <div class="formRight">
                        <select name="EXA_AGENDAMENTO" id="EXA_AGENDAMENTO" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsExames['EXA_AGENDAMENTO']))) {echo "selected=\"selected\"";} ?>>0 - Sim</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsExames['EXA_AGENDAMENTO']))) {echo "selected=\"selected\"";} ?>>1 - Não</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                  </div>
                  ...
                  <div class="rowElem">
                    <label>Sigla:</label>
                <div class="formRight">
                  <input name="EXA_SIGLA" type="text" id="EXA_SIGLA" value="<?php echo $row_rsExames['EXA_SIGLA']; ?>" size="" />
                    ...
                    <div class="rowElem ">
                  <label>Tags:</label>
                  <div class="formRight"><input name="EXA_TAGS" type="text" id="EXA_TAGS" value="<?php echo $row_rsExames['EXA_TAGS']; ?>"/></div><div class="fix"></div></div>
                  
                                  
                  <div class="rowElem">
                        <label>Orientações:</label><div class="formRight"><textarea name="EXA_ORIENTACOES" cols="" rows="5" class="wysiwyg" id="EXA_ORIENTACOES"><?php echo $row_rsExames['EXA_ORIENTACOES']; ?></textarea></div><div class="fix"></div></div>
