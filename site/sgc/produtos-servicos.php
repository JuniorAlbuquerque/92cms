        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            ...
            <tr class="gradeA">
              ...
              <!-- cover -->
              <td class="center"><a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>-cover&amp;URL_DIR=produtos-servicos&amp;IMG_SIZE=1000 x 900 pixel [JPG] [50% Qualidade]&amp;INAME=<?php echo $row_rsPRODUTOS_SERVICOS['PRD_TITULO']; ?>" target="_blank"> <img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /></a>
                <?php If (file_exists('../images/content/produtos-servicos/'.$row_rsPRODUTOS_SERVICOS['PRD_COD'].'-cover.jpg')) { ?>
                <a href="/images/content/produtos-servicos/<?php echo $row_rsPRODUTOS_SERVICOS['PRD_COD']; ?>-cover.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>
              <?php } ?></td>
              <!-- end:cover -->
