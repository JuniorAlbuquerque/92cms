        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            ...
            <tr class="gradeX">
              ...
              <td class="center" >&nbsp;</td>
              <td class="center">
                <a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsLOJAS['LOJ_COD']; ?>&amp;URL_DIR=lojas&amp;IMG_SIZE=800 x 600 pixel [JPG]&amp;INAME=<?php echo $row_rsLOJAS['LOJ_NOME']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
