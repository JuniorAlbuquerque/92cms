...
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_convenios where CONV_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_convenios WHERE CONV_status = 0";
...
$colname_rsLOJAS = "1";
if (isset($_GET['URL_CONV_STATUS'])) {
  $colname_rsLOJAS = $_GET['URL_CONV_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsLOJAS = sprintf("SELECT * FROM tb_convenios WHERE CONV_STATUS = %s ORDER BY CONV_COD ASC", GetSQLValueString($colname_rsLOJAS, "int"));
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="convenios.php?URL_CONV_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="convenios-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          ...
          <li class="last"><a href="clientes.php?URL_CONV_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="convenios-edit.php?URL_CONV_COD=<?php echo $row_rsLOJAS['CONV_COD']; ?>"><?php echo $row_rsLOJAS['CONV_COD']; ?> - <?php echo $row_rsLOJAS['CONV_NOME']; ?></a></td>
              <td class="center" >&nbsp;</td>
              <td class="center">
                <a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsLOJAS['CONV_COD']; ?>&amp;URL_DIR=convenios&amp;IMG_SIZE=325 x 260 pixel [PNG]&amp;INAME=<?php echo $row_rsLOJAS['CONV_NOME']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
                
              <?php If (file_exists('../images/content/convenios/'.$row_rsLOJAS['CONV_COD'].'.png')) { ?> <a href="/images/content/convenios/<?php echo $row_rsLOJAS['CONV_COD']; ?>.png" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?></td>
              <td class="center">
              
              
              
              
              <?php $url_dis_status = isset( $_GET['URL_CONV_STATUS'] ) ? $_GET['URL_CONV_STATUS'] : null; ?>
              <?php
              ...
              <!-- ativa -->
              <a href="active.php?URL_CHAVE=<?php echo $row_rsLOJAS['CONV_COD']; ?>&amp;URL_REDIR=convenios.php&amp;URL_TABLE=tb_convenios&amp;URL_PREFIX=CONV_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
			...
			?>
              ...
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsLOJAS['CONV_COD']; ?>&amp;URL_REDIR=convenios.php&amp;URL_TABLE=tb_convenios&amp;URL_PREFIX=CONV_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
