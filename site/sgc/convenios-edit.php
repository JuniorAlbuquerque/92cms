...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE tb_convenios SET CONV_NOME=%s, CONV_ENDERECO=%s, CONV_LOC_LAT=%s, CONV_LOC_LNG=%s, CONV_STATUS=%s, CONV_URL=%s, CONV_TELEFONE=%s, CONV_EMAIL=%s, CONV_WHATS=%s, CONV_FUNCIONAMENTO=%s WHERE CONV_COD=%s",
                       GetSQLValueString($_POST['CONV_NOME'], "text"),
                       GetSQLValueString($_POST['CONV_ENDERECO'], "text"),
                       GetSQLValueString($_POST['CONV_LOC_LAT'], "double"),
                       GetSQLValueString($_POST['CONV_LOC_LNG'], "double"),
                       GetSQLValueString($_POST['CONV_STATUS'], "int"),
                       GetSQLValueString($_POST['CONV_URL'], "text"),
                       GetSQLValueString($_POST['CONV_TELEFONE'], "text"),
                       GetSQLValueString($_POST['CONV_EMAIL'], "text"),
                       GetSQLValueString($_POST['CONV_WHATS'], "text"),
                       GetSQLValueString($_POST['CONV_FUNCIONAMENTO'], "text"),
                       GetSQLValueString($_POST['CONV_COD'], "int"));

  mysql_select_db($database_conn92ID, $conn92ID);
  $Result1 = mysql_query($updateSQL, $conn92ID) or die(mysql_error());

  $updateGoTo = "convenios.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_rsLojas = "-1";
if (isset($_GET['URL_CONV_COD'])) {
  $colname_rsLojas = $_GET['URL_CONV_COD'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsLojas = sprintf("SELECT * FROM tb_convenios WHERE CONV_COD = %s", GetSQLValueString($colname_rsLojas, "int"));
...
<div class="wrapper">
    ...
    <div class="leftNav">
    	<ul id="menu">
            ...
            -->
            <li class="dash"><a href="exames.php?urlactive=07" title=""  ><span>Exames</span></a></li>
            <li class="dash"><a href="convenios.php?urlactive=07" title=""  ><span>Convênios</span></a></li>
            ...
            <li class="dash"><a href="lojas.php?urlactive=07" title=""  ><span>Unidades</span></a></li>
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input name="CONV_COD" type="hidden" id="CONV_COD" value="<?php echo $row_rsLojas['CONV_COD']; ?>" />
                  <div class="formRight"><input name="CONV_NOME" type="text" id="CONV_NOME" value="<?php echo $row_rsLojas['CONV_NOME']; ?>"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                      <label>Status</label>
                        <div class="formRight">
                        <select name="CONV_STATUS" id="CONV_STATUS" >
                          <option value="0" <?php if (!(strcmp(0, $row_rsLojas['CONV_STATUS']))) {echo "selected=\"selected\"";} ?>>0 - Inativa</option>
                          <option value="1" <?php if (!(strcmp(1, $row_rsLojas['CONV_STATUS']))) {echo "selected=\"selected\"";} ?>>1 - Ativa</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                    </div>
                ...
                <div class="formRight">
                  <input name="CONV_ENDERECO" type="text" id="CONV_ENDERECO" value="<?php echo $row_rsLojas['CONV_ENDERECO']; ?>" size="" />
                  ...
                  <div class="rowElem">
                        ...
                        <div class="formRight">
                            <div class="floatleft">
                              <input name="CONV_LOC_LAT" type="text" id="CONV_LOC_LAT" value="<?php echo $row_rsLojas['CONV_LOC_LAT']; ?>" />
                            </div>
                            <div class="floatleft" style="margin-left: 20px;">
                              <input name="CONV_LOC_LNG" type="text" id="CONV_LOC_LNG" value="<?php echo $row_rsLojas['CONV_LOC_LNG']; ?>" />
                            </div>
                  ...
                  <div class="formRight"><input name="CONV_TELEFONE" type="text" id="CONV_TELEFONE" value="<?php echo $row_rsLojas['CONV_TELEFONE']; ?>"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem ">
                  <label>Email:</label>
                  <div class="formRight"><input name="CONV_EMAIL" type="text" id="CONV_EMAIL" value="<?php echo $row_rsLojas['CONV_EMAIL']; ?>"/></div><div class="fix"></div></div>
                    
                  <div class="rowElem">
                    <label>WhatsApp:</label>
                <div class="formRight">
                  <input name="CONV_WHATS" type="text" id="CONV_WHATS" value="<?php echo $row_rsLojas['CONV_WHATS']; ?>" size="" />
                </div><div class="fix"></div></div>
                
                <div class="rowElem">
                    <label>Foursquare/Gmaps Url:</label>
                <div class="formRight">
                  <input name="CONV_URL" type="text" id="CONV_URL" value="<?php echo $row_rsLojas['CONV_URL']; ?>" size="" />
                </div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="CONV_FUNCIONAMENTO" type="text" id="CONV_FUNCIONAMENTO" value="<?php echo $row_rsLojas['CONV_FUNCIONAMENTO']; ?>" size="" />
                </div><div class="fix"></div></div>
