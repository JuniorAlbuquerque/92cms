...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_convenios (CONV_COD, CONV_NOME, CONV_ENDERECO, CONV_LOC_LAT, CONV_LOC_LNG, CONV_STATUS, CONV_URL, CONV_TELEFONE, CONV_EMAIL, CONV_WHATS, CONV_FUNCIONAMENTO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="CONV_COD" id="CONV_COD" />
                  <div class="formRight"><input name="CONV_NOME" type="text" id="CONV_NOME"/></div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="CONV_ENDERECO" type="text" id="CONV_ENDERECO" value="" size="" />
                  ...
                  <div class="rowElem">
                        ...
                        <div class="formRight">
                            <div class="floatleft">
                              <input name="CONV_LOC_LAT" type="text" id="CONV_LOC_LAT" />
                            </div>
                            <div class="floatleft" style="margin-left: 20px;">
                              <input name="CONV_LOC_LNG" type="text" id="CONV_LOC_LNG" />
                            </div>
                  ...
                  <div class="formRight"><input name="CONV_TELEFONE" type="text" id="CONV_TELEFONE"/></div><div class="fix"></div></div>
                  
                  <div class="rowElem ">
                  <label>Email:</label>
                  <div class="formRight"><input name="CONV_EMAIL" type="text" id="CONV_EMAIL"/></div><div class="fix"></div></div>
                    
                  <div class="rowElem">
                    <label>WhatsApp:</label>
                <div class="formRight">
                  <input name="CONV_WHATS" type="text" id="CONV_WHATS" value="" size="" />
                </div><div class="fix"></div></div>
                
                <div class="rowElem">
                    <label>Foursquare/Gmaps Url:</label>
                <div class="formRight">
                  <input name="CONV_URL" type="text" id="CONV_URL" value="" size="" />
                </div><div class="fix"></div></div>
                ...
                <div class="formRight">
                  <input name="CONV_FUNCIONAMENTO" type="text" id="CONV_FUNCIONAMENTO" value="" size="" />
                </div><div class="fix"></div></div>
