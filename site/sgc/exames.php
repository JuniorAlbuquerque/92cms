...
$query_rsCOUNT_ACTIVE = "SELECT COUNT(*) AS TOT_ACTIVE FROM tb_exames where EXA_status = 1";
...
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsCOUNT_INACTIVE = "SELECT COUNT(*) AS TOT_INACTIVE FROM tb_exames WHERE EXA_status = 0";
...
$colname_rsEXAMES = "1";
if (isset($_GET['URL_EXA_STATUS'])) {
  $colname_rsEXAMES = $_GET['URL_EXA_STATUS'];
}
mysql_select_db($database_conn92ID, $conn92ID);
$query_rsEXAMES = sprintf("SELECT * FROM tb_exames WHERE EXA_STATUS = %s ORDER BY EXA_COD ASC", GetSQLValueString($colname_rsEXAMES, "int"));
...
<title>Exames &bull; 92ID:CMS &bull; &copy;92dpi</title>
<!-- InstanceEndEditable -->
...
<div id="header" class="wrapper">
    ...
    <div class="middleNav">
    	<ul>
        	...
        	<li class="iUser"><a href="exames.php?URL_EXA_STATUS=0" title=""><span>Inativos</span></a></li>
        	<li class="iOrders"><a href="exames-ins.php?urlactive=02" title="Inserir Novo"><span>Inserir Novo</span></a></li>
			<!-- InstanceEndEditable -->
        </ul>
    </div>
    <div class="fix"></div>
...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="stats">
        <ul>
          <li><a href="exames.php" class="count green" title=""><?php echo $row_rsCOUNT_ACTIVE['TOT_ACTIVE']; ?></a><span>Registros Ativos</span></li>
          <li class="last"><a href="exames.php?URL_EXA_STATUS=0" class="count red" title=""><?php echo $row_rsCOUNT_INACTIVE['TOT_INACTIVE']; ?></a><span>Registros Inativos</span></li>
        </ul>
        <div class="fix"></div>
      </div>
      <!-- Static table -->
      ...
      <div class="table">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <tbody>
            <?php do { ?>
            <tr class="gradeX">
              <td><a href="exames-edit.php?URL_EXA_COD=<?php echo $row_rsEXAMES['EXA_COD']; ?>"><?php echo $row_rsEXAMES['EXA_COD']; ?> - <?php echo $row_rsEXAMES['EXA_NOME']; ?></a></td>
              <td class="center" >&nbsp;</td>
              <td class="center">
                <a href="/sgc/upload-single.php?URL_FILENAME=<?php echo $row_rsEXAMES['EXA_COD']; ?>&amp;URL_DIR=lojas&amp;IMG_SIZE=300 x 170 pixel [JPG]&amp;INAME=<?php echo $row_rsEXAMES['EXA_NOME']; ?>" target="_blank"><img src="images/icons/color/arrow-curve-090.png" alt="" class="mr10" /> </a>
                
              <?php If (file_exists('../images/content/lojas/'.$row_rsEXAMES['EXA_COD'].'.jpg')) { ?> <a href="/images/content/lojas/<?php echo $row_rsEXAMES['EXA_COD']; ?>.jpg" class="group1" ><img src="images/icons/color/image-resize-actual.png" alt="" class="mr10" /></a>                <?php } ?></td>
              <td class="center">
              
              
              
              
              <?php $url_dis_status = isset( $_GET['URL_EXA_STATUS'] ) ? $_GET['URL_EXA_STATUS'] : null; ?>
              <?php
              ...
              <!-- ativa -->
              <a href="active.php?URL_CHAVE=<?php echo $row_rsEXAMES['EXA_COD']; ?>&amp;URL_REDIR=exames.php&amp;URL_TABLE=tb_exames&amp;URL_PREFIX=EXA_"><img src="images/icons/color/tick.png" alt="" class="mr10" /></a>
			...
			?>
              ...
              <!-- desativa -->
              <a href="inactive.php?URL_CHAVE=<?php echo $row_rsEXAMES['EXA_COD']; ?>&amp;URL_REDIR=exames.php&amp;URL_TABLE=tb_exames&amp;URL_PREFIX=EXA_"><img src="images/icons/color/cross.png" alt="" class="mr10" /></a>
