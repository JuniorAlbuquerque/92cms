...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO tb_exames (EXA_COD, EXA_NOME, EXA_SIGLA, EXA_TAGS, EXA_ORIENTACOES, EXA_AGENDAMENTO, EXA_STATUS) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<title>Inserir &laquo; Exames &laquo; 92ID:CMS &laquo; &copy;92dpi</title>
<!-- InstanceEndEditable -->
        ...
        <form action="<?php echo $editFormAction; ?>" method="POST" name="form" class="mainForm">
            ...
            <fieldset>
                <div class="widget first">
                  ...
                  <label>Nome:</label>
                  <input type="hidden" name="EXA_COD" id="EXA_COD" />
                  <div class="formRight"><input name="EXA_NOME" type="text" id="EXA_NOME"/></div><div class="fix"></div></div>
                  ...
                  <div class="rowElem">
                      <label>Agendamento?</label>
                        ...
                        <select name="EXA_AGENDAMENTO" id="EXA_AGENDAMENTO" >
                          ...
                          <option value="1" selected="selected">1 - Não</option>
                        </select>
                        </div>
                        <div class="fix"></div>
                  </div>
                  ...
                  <div class="rowElem">
                    <label>Sigla:</label>
                <div class="formRight">
                  <input name="EXA_SIGLA" type="text" id="EXA_SIGLA" value="" size="" />
                    ...
                    <div class="rowElem ">
                  <label>Tags:</label>
                  <div class="formRight"><input name="EXA_TAGS" type="text" id="EXA_TAGS"/></div><div class="fix"></div></div>
                  
                                  
                  <div class="rowElem">
                        <label>Orientações:</label><div class="formRight"><textarea name="EXA_ORIENTACOES" cols="" rows="5" class="wysiwyg" id="EXA_ORIENTACOES"></textarea></div><div class="fix"></div></div>
