...
if (isset($_GET['pageNum_rsBlog_Outros'])) {
  $pageNum_rsBlog_Outros = $_GET['pageNum_rsBlog_Outros'];
}
...
<title> <?php echo $row_rsBlog_Detail['DIC_TITULO']; ?> « Blog  « CDL Laboratórios Santos e Vidal - Manaus / Amazonas</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="py-5 text-center">
                          <h1 class="heading heading-1 c-white strong-400 text-normal"> Blog do CDL </h1>
                          <span class="clearfix"></span>
                          <div class="fluid-paragraph fluid-paragraph-sm c-gray-light strong-300 text-center c-white mt-3"> Acompanhe as dicas em nosso Blog. </div>
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="block block-post">
                              ...
                              <div class="mb-4">
                                            <h3 class="heading heading-2 strong-400 text-normal">
                                                <?php echo $row_rsBlog_Detail['DIC_TITULO']; ?>                                          </h3>
                                            <ul class="inline-links inline-links--style-2 mt-1">
                                                <li>
                                                    <?php echo $row_rsBlog_Detail['DIC_CORPO_HOME']; ?>
                                                </li>
                                        ...
                                        <div class="block-image">
                                            <img src="../images/content/dicas/<?php echo $row_rsBlog_Detail['DIC_COD']; ?>.jpg" class="rounded">
                                        </div>
                                ...
                                <div class="block-body block-post-body">
                                    <p>
                                        <?php echo $row_rsBlog_Detail['DIC_CORPO']; ?>
                                    </p>
                                ...
                                <div class="col-lg-4">
                                    <div class="block block-image-holder image-animate-wrapper">
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <a href="d.php?id=<?php echo $row_rsBlog_Outros['DIC_COD']; ?>" class="heading heading-4 d-block strong-500 mt-1"><?php echo $row_rsBlog_Outros['DIC_TITULO']; ?></a>
                                            <p class="mt-3">
                                                <?php echo $row_rsBlog_Outros['DIC_CORPO_HOME']; ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
