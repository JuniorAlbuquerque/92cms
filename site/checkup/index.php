...
$rsCheckups = mysql_query($query_rsCheckups, $conn92ID) or die(mysql_error());
$row_rsCheckups = mysql_fetch_assoc($rsCheckups);
$totalRows_rsCheckups = mysql_num_rows($rsCheckups);
?>
<!DOCTYPE html>
...
<title>Checkups « CDL Laboratórios Santos e Vidal - Manaus / Amazonas</title>
<!-- InstanceEndEditable -->
<!-- Bootstrap -->
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="py-5 text-center">
                          <h1 class="heading heading-1 c-white strong-400 text-normal"> Check-Up </h1>
                          <span class="clearfix"></span>
                          <div class="fluid-paragraph fluid-paragraph-sm c-gray-light strong-300 text-center c-white mt-3"> Prevenção é fundamental para uma vida saudável. Se você é uma pessoa que se preocupa com a saúde, então deve incluir no planejamento a realização de check-up. Oferecemos avaliações personalizadas para você. </div>
                        </div>
                      </div>
                    </div>
                  </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="block block-image-holder">
                                        <div class="block-image">
                                            <img src="../images/content/produtos-servicos/<?php echo $row_rsCheckups['PRD_COD']; ?>-cover.jpg">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="tabs tabs--style-2" role="tabpanel">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#tabTwo-1" aria-controls="home" role="tab" data-toggle="tab" class="nav-link active text-center text-normal strong-600">Sobre este Check-Up</a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#tabTwo-2" aria-controls="profile" role="tab" data-toggle="tab" class="nav-link text-center text-normal strong-600">Lista de Exames</a>
                                                    </li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane" id="tabTwo-2">
                                                        <div class="tab-body">
                                                            <p>
                                                               <?php echo $row_rsCheckups['PRD_CORPO']; ?>
                                                            </p>
